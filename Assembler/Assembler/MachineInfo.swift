...
// Same as TypeM but for extended instructions with two register operands
...
// Same as TypeM but for extended instructions with Immediate
...
class MachineInstrList
{
  ...
  [
    ...
    Instruction( "--0".d,    [OpReg(.indirect), OpImm(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.immediate], op:0b000, fn:0),
    Instruction( "--1".d,    [OpReg(.indirect), OpImm(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.immediate], op:0b001, fn:0),
    Instruction( "cmp".d,    [OpReg(.indirect), OpImm(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.immediate], op:0b010, fn:0),
    Instruction( "mov".d,    [OpReg(.indirect), OpImm(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.immediate], op:0b011, fn:0),
    Instruction( "add".d,    [OpReg(.indirect), OpImm(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.immediate], op:0b100, fn:0),
    Instruction( "adc".d,    [OpReg(.indirect), OpImm(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.immediate], op:0b101, fn:0),
    Instruction( "dad".d,    [OpReg(.indirect), OpImm(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.immediate], op:0b110, fn:0),
    Instruction( "dac".d,    [OpReg(.indirect), OpImm(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.immediate], op:0b111, fn:0),
    ...
    Instruction( "adc".d,    [OpReg(.indirect), OpSym(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.absolute], op:0b101, fn:0),
    Instruction( "dad".d,    [OpReg(.indirect), OpSym(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.absolute], op:0b110, fn:0),
    Instruction( "dac".d,    [OpReg(.indirect), OpSym(.indirect), OpReg()] )    : (ty:TypeM.self,  kind:[.absolute], op:0b111, fn:0),
    
    // Type M store
    
    Instruction( "--0".d,    [OpReg(), OpReg(.indirect), OpImm(.indirect)] )    : (ty:TypeM_s.self,  kind:[.immediate], op:0b000, fn:0),
    Instruction( "--1".d,    [OpReg(), OpReg(.indirect), OpImm(.indirect)] )    : (ty:TypeM_s.self,  kind:[.immediate], op:0b001, fn:0),
    Instruction( "--2".d,    [OpReg(), OpReg(.indirect), OpImm(.indirect)] )    : (ty:TypeM_s.self,  kind:[.immediate], op:0b010, fn:0),
    Instruction( "mov".d,    [OpReg(), OpReg(.indirect), OpImm(.indirect)] )    : (ty:TypeM_s.self,  kind:[.immediate], op:0b011, fn:0),
    Instruction( "add".d,    [OpReg(), OpReg(.indirect), OpImm(.indirect)] )    : (ty:TypeM_s.self,  kind:[.immediate], op:0b100, fn:0),
    Instruction( "adc".d,    [OpReg(), OpReg(.indirect), OpImm(.indirect)] )    : (ty:TypeM_s.self,  kind:[.immediate], op:0b101, fn:0),
    Instruction( "dad".d,    [OpReg(), OpReg(.indirect), OpImm(.indirect)] )    : (ty:TypeM_s.self,  kind:[.immediate], op:0b110, fn:0),
    Instruction( "dac".d,    [OpReg(), OpReg(.indirect), OpImm(.indirect)] )    : (ty:TypeM_s.self,  kind:[.immediate], op:0b111, fn:0),
    ...
    Instruction( "adc".d,    [OpReg(), OpReg(.indirect), OpSym(.indirect)] )    : (ty:TypeM_s.self,  kind:[.absolute], op:0b101, fn:0),
    Instruction( "dad".d,    [OpReg(), OpReg(.indirect), OpSym(.indirect)] )    : (ty:TypeM_s.self,  kind:[.absolute], op:0b110, fn:0),
    Instruction( "dac".d,    [OpReg(), OpReg(.indirect), OpSym(.indirect)] )    : (ty:TypeM_s.self,  kind:[.absolute], op:0b111, fn:0),

    // Type ZP load
    
    Instruction( "--0".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b000, fn:0b00),
    Instruction( "--1".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b001, fn:0b00),
    Instruction( "cmp".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b010, fn:0b00),
    Instruction( "mov".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b011, fn:0b00),
    Instruction( "add".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b100, fn:0b00),
    Instruction( "adc".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b101, fn:0b00),
    Instruction( "dad".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b110, fn:0b00),
    Instruction( "dac".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b111, fn:0b00),
    
    Instruction( "--2".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b000, fn:0b01),
    Instruction( "--3".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b001, fn:0b01),
    Instruction( "cpc".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b010, fn:0b01),
    Instruction( "set".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b011, fn:0b01),
    Instruction( "sub".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b100, fn:0b01),
    Instruction( "sbc".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b101, fn:0b01),
    Instruction( "and".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b111, fn:0b01),
    
    Instruction( "--4".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b000, fn:0b10),
    Instruction( "--5".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b001, fn:0b10),
    Instruction( "--6".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b010, fn:0b10),
    Instruction( "sef".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b011, fn:0b10),
    Instruction( "adt".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b100, fn:0b10),
    Instruction( "adf".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b101, fn:0b10),
    Instruction( "or".d,     [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b110, fn:0b10),
    Instruction( "rsb".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b111, fn:0b10),
    
    Instruction( "--7".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b000, fn:0b11),
    Instruction( "--8".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b001, fn:0b11),
    Instruction( "--9".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b010, fn:0b11),
    Instruction( "sel".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b011, fn:0b11),
    Instruction( "sbt".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b100, fn:0b11),
    Instruction( "sbf".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b101, fn:0b11),
    Instruction( "xor".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b110, fn:0b11),
    Instruction( "mvl".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b111, fn:0b11),
    ...
    Instruction( "adc".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b101, fn:0b00),
    Instruction( "dad".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b110, fn:0b00),
    Instruction( "dac".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b111, fn:0b00),
    ...
    Instruction( "cpc".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b010, fn:0b01),
    Instruction( "set".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b011, fn:0b01),
    Instruction( "sub".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b100, fn:0b01),
    Instruction( "sbc".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b101, fn:0b01),
    Instruction( "and".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b111, fn:0b01),
    
    Instruction( "--4".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b000, fn:0b10),
    Instruction( "--5".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b001, fn:0b10),
    Instruction( "--6".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b010, fn:0b10),
    Instruction( "sef".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b011, fn:0b10),
    Instruction( "adt".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b100, fn:0b10),
    Instruction( "adf".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b101, fn:0b10),
    Instruction( "or".d,     [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b110, fn:0b10),
    Instruction( "rsb".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b111, fn:0b10),
    ...
    Instruction( "sbt".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b100, fn:0b11),
    Instruction( "sbf".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b101, fn:0b11),
    Instruction( "xor".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b110, fn:0b11),
    Instruction( "mvl".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b111, fn:0b11),
    
    // Type ZP store
    
    Instruction( "--0".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b000, fn:0b00),
    Instruction( "--1".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b001, fn:0b00),
    Instruction( "--2".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b010, fn:0b00),
    ...
    Instruction( "adc".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b101, fn:0b00),
    ...
    Instruction( "--3".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b000, fn:0b01),
    Instruction( "--4".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b001, fn:0b01),
    Instruction( "cpc".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b010, fn:0b01),
    Instruction( "set".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b011, fn:0b01),
    ...
    Instruction( "and".d,     [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b111, fn:0b01),
    
    Instruction( "--5".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b000, fn:0b10),
    Instruction( "--6".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b001, fn:0b10),
    Instruction( "--7".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b010, fn:0b10),
    Instruction( "sef".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b011, fn:0b10),
    Instruction( "adt".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b100, fn:0b10),
    Instruction( "adf".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b101, fn:0b10),
    Instruction( "or".d,     [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b110, fn:0b10),
    Instruction( "rsb".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b111, fn:0b10),
    
    Instruction( "--8".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b000, fn:0b11),
    Instruction( "--9".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b001, fn:0b11),
    Instruction( "--A".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b010, fn:0b11),
    ...
    Instruction( "sbf".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b101, fn:0b11),
    Instruction( "xor".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b110, fn:0b11),
    Instruction( "mvl".d,    [OpReg(), OpImm(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.immediate], op:0b111, fn:0b11),
    ...
    Instruction( "adc".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b101, fn:0b00),
    ...
    Instruction( "sbc".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b101, fn:0b01),
    Instruction( "and".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b111, fn:0b01),
    
    Instruction( "--5".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b000, fn:0b10),
    Instruction( "--6".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b001, fn:0b10),
    Instruction( "--7".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b010, fn:0b10),
    ...
    Instruction( "adf".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b101, fn:0b10),
    Instruction( "or".d,     [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b110, fn:0b10),
    Instruction( "rsb".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b111, fn:0b10),
    
    Instruction( "--8".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b000, fn:0b11),
    Instruction( "--9".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b001, fn:0b11),
    Instruction( "--A".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b010, fn:0b11),
    ...
    Instruction( "sbf".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b101, fn:0b11),
    Instruction( "xor".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b110, fn:0b11),
    Instruction( "mvl".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b111, fn:0b11),
 ...
 // Type R
    ...
    Instruction( "adc".d,    [OpReg(), OpReg(), OpReg()] )                      : (ty:TypeR.self,  kind:[], op:0b101, fn:0b00),
    ...
    Instruction( "sbc".d,    [OpReg(), OpReg(), OpReg()] )                      : (ty:TypeR.self,  kind:[], op:0b101, fn:0b01),
    Instruction( "and".d,     [OpReg(), OpReg(), OpReg()] )                      : (ty:TypeR.self,  kind:[], op:0b110, fn:0b01),
    ...
    Instruction( "--1".d,    [OpCC(), OpReg(), OpReg()] )                       : (ty:TypeR_cmp.self,  kind:[], op:0b010, fn:0b10),
    ...
    Instruction( "rsb".d,    [OpReg(), OpReg(), OpReg()] )                      : (ty:TypeR.self,  kind:[], op:0b111, fn:0b10),
    ...
    Instruction( "sbf".d,    [OpReg(), OpReg(), OpReg()] )                      : (ty:TypeR.self,  kind:[], op:0b101, fn:0b11),
    Instruction( "xor".d,    [OpReg(), OpReg(), OpReg()] )                      : (ty:TypeR.self,  kind:[], op:0b110, fn:0b11),
    Instruction( "mvl".d,    [OpReg(), OpReg(), OpReg()] )                      : (ty:TypeR.self,  kind:[], op:0b111, fn:0b11),
 
    // Type I
    
    Instruction( "--0".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b000, fn:0b00),
    Instruction( "--1".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b001, fn:0b00),
    Instruction( "cmp".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b010, fn:0b00),
    Instruction( "mov".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b011, fn:0b00),
    Instruction( "add".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b100, fn:0b00),
    Instruction( "adc".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b101, fn:0b00),
    Instruction( "dad".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b110, fn:0b00),
    Instruction( "dac".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b111, fn:0b00),
    
    Instruction( "--2".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b000, fn:0b01),
    Instruction( "--3".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b001, fn:0b01),
    Instruction( "cpc".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b010, fn:0b01),
    Instruction( "set".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b011, fn:0b01),
    Instruction( "sub".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b100, fn:0b01),
    Instruction( "sbc".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b101, fn:0b01),
    Instruction( "and".d,     [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b111, fn:0b01),
    
    Instruction( "--4".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b000, fn:0b10),
    Instruction( "--5".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b001, fn:0b10),
    Instruction( "--6".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b010, fn:0b10),
    Instruction( "sef".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b011, fn:0b10),
    Instruction( "adt".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b100, fn:0b10),
    Instruction( "adf".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b101, fn:0b10),
    Instruction( "or".d,     [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b110, fn:0b10),
    Instruction( "rsb".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b111, fn:0b10),
    
    Instruction( "--7".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b000, fn:0b11),
    Instruction( "--8".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b001, fn:0b11),
    Instruction( "--9".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b010, fn:0b11),
    Instruction( "sel".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b011, fn:0b11),
    Instruction( "sbt".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b100, fn:0b11),
    Instruction( "sbf".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b101, fn:0b11),
    Instruction( "xor".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b110, fn:0b11),
    Instruction( "mvl".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b111, fn:0b11),
    ...
    Instruction( "adc".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b101, fn:0b00),
    Instruction( "dad".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b110, fn:0b00),
    Instruction( "dac".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b111, fn:0b00),
    ...
    Instruction( "cpc".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b010, fn:0b01),
    Instruction( "set".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b011, fn:0b01),
    Instruction( "sub".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b100, fn:0b01),
    Instruction( "sbc".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b101, fn:0b01),
    Instruction( "and".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b111, fn:0b01),
    
    Instruction( "--4".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b000, fn:0b10),
    Instruction( "--5".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b001, fn:0b10),
    Instruction( "--6".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b010, fn:0b10),
    Instruction( "sef".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b011, fn:0b10),
    Instruction( "adt".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b100, fn:0b10),
    Instruction( "adf".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b101, fn:0b10),
    Instruction( "or".d,     [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b110, fn:0b10),
    Instruction( "rsb".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b111, fn:0b10),
    ...
    Instruction( "sbt".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b100, fn:0b11),
    Instruction( "sbf".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b101, fn:0b11),
    Instruction( "xor".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b110, fn:0b11),
    Instruction( "mvl".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b111, fn:0b11),
    ...
    Instruction( "bt".d,     [OpSym()] )                                        : (ty:TypeJ.self,  kind:[.relative], op:0b100, fn:0b10),
    Instruction( "bf".d,     [OpSym()] )                                        : (ty:TypeJ.self,  kind:[.relative], op:0b101, fn:0b10),
    Instruction( "jl".d,     [OpSym()] )                                        : (ty:TypeJ.self,  kind:[.absolute], op:0b111, fn:0b11),
...
{
  required convenience init( size:Int, op:Operand ) {
    self.init( size:size, value:op.value )

...
class MachineInstrList
{
  ...
  [
    ...
    Instruction( "sr1".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b000, fn:0b00),
    Instruction( "sl1".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b001, fn:0b00),
    ...
    Instruction( "rr1".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b000, fn:0b01),
    Instruction( "rl1".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b001, fn:0b01),
    Instruction( "cpc".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b010, fn:0b01),
    Instruction( "mvl".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b011, fn:0b01),
    ...
    Instruction( "dsb".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b111, fn:0b01),
    
    Instruction( "sr4".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b000, fn:0b10),
    Instruction( "sl4".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b001, fn:0b10),
    Instruction( "set".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b010, fn:0b10),
    Instruction( "--1".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b011, fn:0b10),
    ...
    Instruction( "and".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b111, fn:0b10),
    
    Instruction( "rr4".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b000, fn:0b11),
    Instruction( "rl4".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b001, fn:0b11),
    Instruction( "sef".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b010, fn:0b11),
    ...
    Instruction( "rsb".d,    [OpImm(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.immediate], op:0b111, fn:0b11),
    
    Instruction( "sr1".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b000, fn:0b00),
    Instruction( "sl1".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b001, fn:0b00),
    ...
    Instruction( "rr1".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b000, fn:0b01),
    Instruction( "rl1".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b001, fn:0b01),
    Instruction( "cpc".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b010, fn:0b01),
    Instruction( "mvl".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b011, fn:0b01),
    ...
    Instruction( "dsb".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b111, fn:0b01),
    
    Instruction( "sr4".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b000, fn:0b10),
    Instruction( "sl4".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b001, fn:0b10),
    Instruction( "set".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b010, fn:0b10),
    Instruction( "--1".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b011, fn:0b10),
    ...
    Instruction( "and".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b111, fn:0b10),
    
    Instruction( "rr4".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b000, fn:0b11),
    Instruction( "rl4".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b001, fn:0b11),
    Instruction( "sef".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b010, fn:0b11),
    ...
    Instruction( "rsb".d,    [OpSym(.indirect), OpReg()] )                      : (ty:TypeZP.self,  kind:[.absolute], op:0b111, fn:0b11),
    ...
    Instruction( "rsb".d,    [OpReg(), OpSym(.indirect)] )                      : (ty:TypeZP_s.self,  kind:[.absolute], op:0b111, fn:0b11),
 ...
 // Type R
    ...
    Instruction( "rsb".d,    [OpReg(), OpReg(), OpReg()] )                      : (ty:TypeR.self,  kind:[], op:0b111, fn:0b11),
 
    // Type I
    
    Instruction( "sr1".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b000, fn:0b00),
    Instruction( "sl1".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b001, fn:0b00),
    ...
    Instruction( "rr1".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b000, fn:0b01),
    Instruction( "rl1".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b001, fn:0b01),
    Instruction( "cpc".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b010, fn:0b01),
    Instruction( "mvl".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b011, fn:0b01),
    ...
    Instruction( "dsb".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b111, fn:0b01),
    
    Instruction( "sr4".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b000, fn:0b10),
    Instruction( "sl4".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b001, fn:0b10),
    Instruction( "set".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b010, fn:0b10),
    Instruction( "--1".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b011, fn:0b10),
    ...
    Instruction( "and".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b111, fn:0b10),
    
    Instruction( "rr4".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b000, fn:0b11),
    Instruction( "rl4".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b001, fn:0b11),
    Instruction( "sef".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b010, fn:0b11),
    ...
    Instruction( "rsb".d,    [OpImm(), OpReg()] )                               : (ty:TypeI.self,  kind:[.immediate], op:0b111, fn:0b11),
    
    Instruction( "sr1".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b000, fn:0b00),
    Instruction( "sl1".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b001, fn:0b00),
    ...
    Instruction( "rr1".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b000, fn:0b01),
    Instruction( "rl1".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b001, fn:0b01),
    Instruction( "cpc".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b010, fn:0b01),
    Instruction( "mvl".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b011, fn:0b01),
    ...
    Instruction( "dsb".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b110, fn:0b01),
    Instruction( "dsc".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b111, fn:0b01),
    
    Instruction( "sr4".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b000, fn:0b10),
    Instruction( "sl4".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b001, fn:0b10),
    Instruction( "set".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b010, fn:0b10),
    Instruction( "--1".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b011, fn:0b10),
    ...
    Instruction( "and".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b111, fn:0b10),
    
    Instruction( "rr4".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b000, fn:0b11),
    Instruction( "rl4".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b001, fn:0b11),
    Instruction( "sef".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b010, fn:0b11),
    ...
    Instruction( "rsb".d,    [OpSym(), OpReg()] )                               : (ty:TypeI.self,  kind:[.absolute], op:0b111, fn:0b11),
    ...
    Instruction( "jl".d,     [OpSym()] )                                        : (ty:TypeJ.self,  kind:[.absolute], op:0b011, fn:0b01),
